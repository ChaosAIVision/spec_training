#!/bin/bash
# Generate MSM midtraining data from QC XU LY TU CHOI rules spec (Ensure)

# Config
PREVIEW=true  # Set to false to run full generation

SPEC_TYPE="rules"
DATASET_NAME="ensure_qc_xu_ly_tu_choi"
PRINCIPLE_NAME="chấm điểm kỹ năng xử lý từ chối telesales"
SPEC_FILE_NAME="ensure/qc_xu_ly_tu_choi_rules_spec"  # path under spec/
