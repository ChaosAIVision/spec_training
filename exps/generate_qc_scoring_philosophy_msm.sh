#!/bin/bash
# Generate MSM midtraining data from QC scoring philosophy spec (Ensure)

# Config
PREVIEW=true  # Set to false to run full generation

SPEC_TYPE="default"
DATASET_NAME="ensure_qc_scoring_philosophy"
PRINCIPLE_NAME="triết lý chấm điểm QC hội thoại telesales"
SPEC_FILE_NAME="ensure/qc_scoring_philosophy_spec"  # path under spec/
