...
model, processor = FastLanguageModel.from_pretrained(
    "/home/chaos/Documents/chaos/project/spec_training/spec_training/outputs/msm/ensure_value_qwen35_4b/final_adapter", # This is a very big model, might take a while for downloading # You can use any model from the list above and HF will download it for you. Depends on your GPU memory.
